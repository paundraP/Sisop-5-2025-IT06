...
1. displayPrompt() untuk menampilkan prompt user> atau username@Host>.

2. readString() untuk membaca input pengguna.

3. parseCommand() untuk memisahkan nama command dan argumennya.

4. processCommand() untuk mengevaluasi dan mengeksekusi command.
